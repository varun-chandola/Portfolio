...
const Contact = () => {
  return (
    <>
      ...
      <div
        id="contactMe"
        className="my-10 socials flex flex-wrap m-auto w-auto justify-center"
      >
        <div className="hovering rounded-full overflow-hidden">
          <a href="#" target="_blank">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwH--J-ZMUg8puNfUxE6YXQi3yVHuAORDxow&s" />
          </a>
        </div>
        <div className="hovering rounded-2xl">
